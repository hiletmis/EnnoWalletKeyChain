...
public let LocksmithDefaultService = Bundle.main.infoDictionary![String(kCFBundleIdentifierKey)] as? String ?? "com.ennowallet.wallet"
...
public extension SecureStorableResultType {
    ...
    var data: [String: Any]? {
        ...
        do {
            let records = try NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(aData as Data) as? [String: Any]
            return records
        } catch {
            return nil
        }
